...
const ExerciseSelector = ({ currentExerciseId, onSelect, overrideUserId = null }) => {
          ...
          <div className="max-h-60 overflow-y-auto">
            {loading ? (
              ...
              results.map(ex => (
                ...
                >
                  <div>
                    <p className="text-xs font-bold text-slate-800">{ex.nome}</p>
              ...
              <div className="p-4 text-center text-xs text-slate-400">Nenhum exercício encontrado.</div>
            )}
          </div>
        </div>
      )}
