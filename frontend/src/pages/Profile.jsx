            ...
            <div className="p-8 space-y-8">
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  disabled={!!creatingPayment}
                  className="w-full py-5 bg-white border-2 border-slate-100 rounded-2xl shadow-xl active:scale-95 transition-all flex flex-col items-center justify-center"
                >
                  <div className="flex items-center justify-center">
                    {creatingPayment === 'native_subscription' ? <Loader2 className="animate-spin text-slate-400" size={20} /> : (
                      <svg xmlns="http://www.w3.org/2000/svg" width="150" height="104" fill="none" viewBox="0 0 150 104" className="h-14 w-auto">
                  ...
                  <span className="text-[9px] text-slate-400 normal-case font-bold italic text-center -mt-2">Para clientes com conta Mercado Pago</span>
                </button>
              </div>
