    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="bg-white rounded-[32px] p-8 shadow-sm border border-slate-200">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h2 className="text-xl font-black text-slate-800 uppercase tracking-widest">Personalizar Cores</h2>
            <p className="text-sm text-slate-500">Ajuste as cores principais do aplicativo.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <ColorInput
            ...
            onChange={(val) => setLocalSettings({ ...localSettings, bg_geral: val })}
            description="Dashboard, Histórico e Perfil"
          />
          <ColorInput
            label="Fundo do Treino (Execução)"
            value={localSettings.bg_treino}
            onChange={(val) => setLocalSettings({ ...localSettings, bg_treino: val })}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="p-6 rounded-[32px] border border-slate-200" style={{ backgroundColor: localSettings.bg_geral }}>
            <p className="text-[10px] font-black uppercase tracking-widest mb-4 opacity-40">Preview Gestão</p>
            <div className="w-full h-12 rounded-xl mb-2" style={{ backgroundColor: localSettings.color_ex_a }}></div>
            <div className="w-2/3 h-12 rounded-xl" style={{ backgroundColor: localSettings.color_ex_b + '20', border: `1px solid ${localSettings.color_ex_b}` }}></div>
        </div>
        <div className="p-6 rounded-[32px] border border-slate-700 shadow-2xl" style={{ backgroundColor: localSettings.bg_treino }}>
            <p className="text-[10px] font-black uppercase tracking-widest mb-4 text-white opacity-40">Preview Treino</p>
            <div className="w-full h-12 rounded-xl mb-2" style={{ backgroundColor: localSettings.color_ex_a }}></div>
            <div className="w-full h-12 rounded-xl opacity-80" style={{ backgroundColor: localSettings.bg_treino, border: `1px dashed ${localSettings.color_ex_b}` }}></div>
        </div>
      </div>
    </div>
  );
