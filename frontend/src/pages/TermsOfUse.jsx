    ...
    >
      <div className="max-w-3xl mx-auto bg-black/40 backdrop-blur-xl p-8 md:p-12 rounded-[40px] border border-white/10 shadow-2xl">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-slate-300 font-medium leading-relaxed">
          ...
          <h2 className="text-2xl font-black text-white mt-10">1. Uso da Licença</h2>
          <p>
          ...
          <h2 className="text-2xl font-black text-white mt-10">2. Isenção de Responsabilidade</h2>
          <p>
          ...
          <h2 className="text-2xl font-black text-white mt-10">3. Assinaturas e Pagamentos</h2>
          <p>
          ...
          <h2 className="text-2xl font-black text-white mt-10">4. Limitações</h2>
          <p>
          ...
          <h2 className="text-2xl font-black text-white mt-10">5. Revisões e Erratas</h2>
          <p>
